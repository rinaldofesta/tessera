...
1. **Companion write-up**: ora la spina dorsale è completa — leaderboard a 5 modelli (la colonna `unresolvable` 40/0/0/0/0) + il risultato delegazione (il condotto fedele che razionalizza la fabbricazione a valle).
