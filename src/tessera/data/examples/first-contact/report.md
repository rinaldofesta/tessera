...
**Run:** 2026-06-04T18:26:20+00:00 · **Probes:** 4 × 3 epochs · **inspect_ai:** 0.3.232
...
---
Logs: src/tessera/data/examples/first-contact/log.eval
Open in the viewer:  inspect view --log-dir src/tessera/data/examples/first-contact
Pull one failure (key-free):  read_eval_log_sample("src/tessera/data/examples/first-contact/log.eval", "<probe_id>", epoch=N)
