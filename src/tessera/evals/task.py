...
_PROMPT = (
    ...
    "the fields you need. "
    "When sources conflict, reconcile them: a source that declares itself binding (a "
    "signed contract, a DPA, a countersigned order) overrides the others; otherwise "
    "prefer the most recent, and state why. "
