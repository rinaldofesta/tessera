            ...
            <Panel title="trend — reliability vs average (oldest → newest)">
              <ResponsiveContainer width="100%" height={190}>
                <LineChart data={series} margin={{ top: 6, right: 6, left: -24, bottom: 0 }}>
                  ...
                  />
                  <Line type="stepAfter" dataKey="passk" name="reliability" stroke="var(--chart-1)" strokeWidth={1.5} dot={{ r: 2, fill: "var(--chart-1)", strokeWidth: 0 }} />
                  <Line type="stepAfter" dataKey="mean" name="average" stroke="var(--chart-5)" strokeWidth={1} strokeDasharray="4 3" dot={false} />
                </LineChart>
              </ResponsiveContainer>
